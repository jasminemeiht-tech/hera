...
class RequestState:
    ...
    def __init__(
        ...
        # Optional oracle length prediction metadata (attached at request
        # creation time and kept until completion).
        self.oracle_metadata: Optional[dict[str, Any]] = None
    ...
    def from_new_request(
        ...
        state.oracle_metadata = getattr(request, "oracle_metadata", None)
        return state
